...
- **[Group]** – Enables filtering of reservations based on whether they belong to a group, with two available controls:
  ...
  - Use the checkbox to filter reservations that belong to a group (checkbox checked) 
    ...
    or do not belong to a group (checkbox unchecked or marked with an X).
    ...
    <img
      ...
      style={{ width:"44%" }}
    />
  - The search field allows you to filter reservations by searching for a specific group. This search works independently of the checkbox status.
- **[Company]**