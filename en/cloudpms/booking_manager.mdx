...
Click "Save" confirm and apply the updates across all selected bookings.
...
The “Cancel” action allows a reservation to be canceled, as long as it has not yet been checked in.

To cancel a reservation, select it, click on the “Actions” button, and choose “Cancel”.

A cancellation window will open with the following fields:

> <img
>   src="/images/05_cancel.png"
>   alt="05 Cancel Pn"
>   title="05 Cancel Pn"
>   style={{ width:"63%" }}
> />
>
> **Date** and **User** – Display the user who performed the cancellation and the date of the action. These fields are not editable\*\*.\*\*
>
> **Reason** – Cancellation Reason must be selected from the available options in the drop-down menu. This field is **mandatory**.
>
> **Comments** – Optional field that allows additional information to be added.
>
> After filling in the required fields, confirm by clicking “Ok”.

<Warning>
  **Notes**:

  - If the reservation has **pending movements**, the system will prevent the cancellation until all movements are invoiced.
  - The cancellation action does not delete the reservation. Instead, it **changes the status** to “cancelled”, and the reservation remains in the system.
</Warning>

### **No-Show**

The “No-Show” action is used when the guests of a reservation do not arrive on the expected check-in date. Applying this action changes the reservation status to “No-Show”.

To assign the “No-Show” status, select the reservation, click the “Actions” button, and choose “No Show”.

This will open the “No-Show” window with several options and information:

> <img
>   src="/images/06_noshow.png"
>   alt="06 Noshow Pn"
>   title="06 Noshow Pn"
>   style={{ width:"60%" }}
> />
>
> **Booking number**, **Arrival date**, and \*\*Departure date - \*\* are displayed but not editable.
>
> **Guaranteed for (days)** – Defines the number of days the reservation remains valid.
>
> **End of Guarantee** – Sets the date until which the guarantee is valid. After this date, the reservation will automatically be set to ****“No Show”****.
>
> **Invoice guarantted days** – Issues an invoice covering the warranty period.
>
> **Close account** – Blocks the reservation’s current account to prevent the registration of further movements.
>
> Confirm the action by selecting **"Ok"**.

<Warning>
  **Check-in** can still be completed the following day if needed.
</Warning>

### Overbooking

The “Overbooking” action is used when a reservation exceeds the hotel’s total occupancy. Applying this action updates the reservation’s status to “Overbooking”.

To mark a reservation as overbooking, select it, click the “Actions” button, and choose “Overbooking”.

This opens the Overbooking window, which includes the following information and fields:

> <img
>   src="/images/07_overbooking.png"
>   alt="07 Overbooking Pn"
>   title="07 Overbooking Pn"
>   style={{ width:"61%" }}
> />
>
> \*\*Reservation number, Arrival date \*\* and **Departure date** -  are displayed and not editable.
>
> **Hotel** - is mandatory and must indicate the name of the hotel where the guest was relocated.
>
> **Room -** is optional and can be used to specify the room number at the alternate hotel.
>
> **Invoice Overbooking** - allows billing to be issued for the overbooking, if applicable.
>
> Fill in the necessary fields and confirm the action by selecting **“Ok”**.

### Change Room

Allows the reassignment of the originally allocated room. This action can be used in cases such as unexpected maintenance issues, upselling, or other valid reasons that justify changing the guest’s accommodation.

### Transfer

Allows an existing reservation to be transferred to another unit within the hotel group.

A new window will open where the destination unit and the accommodation type must be selected.

A second window will then appear showing the original room type. The new room type to be assigned must be selected and confirmed by clicking "Transfer".

> **Note:** For more details, see the Transfer Reservation section of the manual.\
> <Icon icon="link" color="#fa0000" /> <u>Reservation Transfer</u>

<Warning>
  **Notes**:

  - Only available when multiple hotels exist in the **cloud database**.
  - This option is only available for hotels that belong to a hotel \*\*chain \*\*or **group**.
</Warning>

### Update Prices

The Update Prices action recalculates the value of the reservation based on the selected rate.

When this action is used, a confirmation popup appear, click "OK" to proceed with the update.

<img
  src="/images/booking_manager_actions/08_update_prices.png"
  alt="08 Update Prices Pn"
  title="08 Update Prices Pn"
  style={{ width:"49%" }}
/>

### UpSell

The Upsell action allows additional services to be added to a reservation. This option is available through the Actions button.

When selected, a new window will open where the upsell details must be entered. After filling in the required fields, confirm the upsell by clicking "Ok".

![09 Upsell Pn](/images/09_upsell.png)

### Registration Card / Key-pass

The "Registration Card / Key-Pass" option is available under the Actions button, providing quick access to these documents without needing to open the full reservation.\
This action allows the user to generate and access the registration card associated with the selected reservation.

When generating the registration card, the following options are available:

> <img
>   src="/images/10_keypass_action.png"
>   alt="10 Keypass Action Pn"
>   title="10 Keypass Action Pn"
>   style={{ width:"38%" }}
> />
>
> **Include Price Details**: Displays pricing information on the document.
>
> **Guest Lang.**: If enabled, the document is generated in the guest’s language

### Reservation Label

The "Reservation Label option" is available under the Actions button, providing quick access to these documents without needing to open the full reservation. This  action opens a "Reservation Label" window that allows the user to configure and print labels related to a reservation.

The following options are available:

> <img
>   src="/images/11_res_label_modal.png"
>   alt="11 Res Label Modal Pn"
>   title="11 Res Label Modal Pn"
>   style={{ width:"58%" }}
> />
>
> **By reservation** / **By guest**: Choose whether to generate one label per reservation or per guest.
>
> **No. of bags**: Specify the number of bags, if applicable.
>
> **Only end label**: When selected, only the final label in the set will be printed.
>
> After configuring the desired options, click "**OK"** to generate the label(s).

Reservation Label(s) will then be displayed and can be printed directly or saved as a PDF file.

### Print (Bulletin Reservation)

The "Bulletin Reservation" action is available under the Actions button, through the "Print" option.

This option allows you to print the reservation form pre-filled with the data registered in the reservation.\
When selected, a window will appear where you can choose which details to include in the bulletin.:

> <img
>   src="/images/12_bulletin_modal.png"
>   alt="12 Bulletin Modal Pn"
>   title="12 Bulletin Modal Pn"
>   style={{ width:"32%" }}
> />
>
> Select the desired information and click "Ok" to confirm.

The guest bulletin will then be displayed and can be printed directly or saved as a PDF file.

### SPA Schedule

**Spa Schedule**\
The "Spa Schedule" option allows you to generate and print the schedule of spa services booked for a specific period.

When selected, a configuration window will appear:

- **Group by date**: Tick this box to group appointments by day, making the printed plan easier to read
- **Language**: Choose the language for the printed schedule; by default, it follows the application's language

After selecting the desired options, click **"OK"** to generate the schedule.\
The spa schedule can then be printed or saved as a PDF for internal use, staff coordination, or display purposes.

<Warning>
  This feature is only available if the Cloud – Spa module is active.
</Warning>
